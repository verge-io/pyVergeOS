...
class ClusterTierStatsHistoryLong(ResourceObject):
    ...
    def capacity_bytes(self) -> int:
        ...
        return int(self.require_projected("capacity", 0))
    ...
    def used_bytes(self) -> int:
        ...
        return int(self.require_projected("used", 0))
...
class ClusterTierStatsHistoryShort(ResourceObject):
    ...
    def read_ops(self) -> int:
        ...
        return int(self.require_projected("rops", 0))

    @property
    def write_ops(self) -> int:
        """Write operations per second."""
        return int(self.require_projected("wops", 0))

    @property
    def read_bps(self) -> int:
        """Read bytes per second."""
        return int(self.require_projected("rbps", 0))

    @property
    def write_bps(self) -> int:
        """Write bytes per second."""
        return int(self.require_projected("wbps", 0))
...
class ClusterTierStatus(ResourceObject):
    ...
    def is_redundant(self) -> bool:
        ...
        return bool(self.require_projected("redundant", False))

    @property
    def is_encrypted(self) -> bool:
        """Check if tier is encrypted."""
        return bool(self.require_projected("encrypted", False))

    @property
    def is_working(self) -> bool:
        """Check if tier is actively working."""
        return bool(self.require_projected("working", False))
